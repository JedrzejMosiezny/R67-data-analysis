...
path_rms = 'D:/01_DOKTORAT/13_PLGRID/noise-data/lead-post/rms'
path_coords = 'D:/01_DOKTORAT/13_PLGRID/noise-data/lead-post/coords'
...
coords.to_csv(str('lead_coords.dat'), sep=',')
