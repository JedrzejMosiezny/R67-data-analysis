...
path_fft = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-04-post/fft'
...
path_rms = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-04-post/rms'
print("Loaded directories...")
...
os.chdir(path_acu)
batch_pressure = dd.read_csv('int-04*', delimiter=",", decimal='.',usecols=["nodenumber", "sound-pressure"])
...
os.chdir(path_fft)
node_fft_max.to_csv(str('int-04_fft_max.dat'), sep=",")
