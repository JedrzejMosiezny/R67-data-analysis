...
path_fft = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-03-post/fft'
...
#PLGRID
print("Loading directories..")
#path_data = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-03'
...
os.chdir(path_acu)
batch_pressure = dd.read_csv('int-03*', delimiter=",", decimal='.',usecols=["nodenumber", "sound-pressure"])
...
os.chdir(path_fft)
node_fft_max.to_csv(str('int-03_fft_max.dat'), sep=",")
