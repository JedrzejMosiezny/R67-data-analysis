...
path_rms = 'D:/01_DOKTORAT/13_PLGRID/noise-data/sside-post/rms'
path_coords = 'D:/01_DOKTORAT/13_PLGRID/noise-data/sside-post/coords'
...
path_fft = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/sside-post/fft'
path_rms = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/sside-post/rms'
path_coords = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/sside-post/coords'
print("Loaded directories...")
...
coords.to_csv(str('sside_coords.dat'), sep=',')
