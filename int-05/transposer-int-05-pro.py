...
path_signal = 'C:/Users/JMosiezny/Documents/01_PUT/01_DOKTORAT/13_PLGRID/noise-data/int-05-post/signal'
...
#path_rms = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-05-post/rms'
print("Loaded directories...")

'''
print("Loading directories..")
path_data = '/net/archive/groups/plggcfdp/R67_fluent/SRS_v02/noise-data/int-05'
#path_post = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-05-post'
...
path_signal = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-05-post/signal'
...
for i in nodelist:
    ...
    node_ts.to_csv(str('int-05_acu_node_' + str(i) +'.dat'), sep=",")