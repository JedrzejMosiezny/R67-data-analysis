...
path_rms = 'D:/01_DOKTORAT/13_PLGRID/noise-data/trail-post/rms'
path_coords = 'D:/01_DOKTORAT/13_PLGRID/noise-data/trail-post/coords'
...
coords.to_csv(str('trail_coords.dat'), sep=',')
