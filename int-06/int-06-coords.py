...
path_coords = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-06-post/coords'
...
path_fft = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-06-post/fft'
path_rms = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-06-post/rms'
path_coords = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-06-post/coords'
print("Loaded directories...")
...
coords.to_csv(str('int-06_coords.dat'), sep=',')
