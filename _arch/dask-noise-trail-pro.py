...
print("Loading directories..")
path_data = '/net/archive/groups/plggcfdp/R67_fluent/SRS_v02/noise-data/trail'
#path_post = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/trail-post'
path_acu = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/trail-post/acu'
#path_plots = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/trail-post/plots'
print("Loaded directories...")
...
for file in filelist:
    ...
    os.chdir(path_acu)
    acoustic_data.to_csv(str('trail_acu_' + str(timestep) + '.dat'), sep=',')
    print(str('trail_acu_' + str(timestep) + '.dat done...'))
