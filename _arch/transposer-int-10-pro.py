...
path_signal = 'C:/Users/JMosiezny/Documents/01_PUT/01_DOKTORAT/13_PLGRID/noise-data/int-10-post/signal'
...
path_signal = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-10-post/signal'
...
for i in nodelist:
    ...
    node_ts.to_csv(str('int-10_acu_node_' + str(i) +'.dat'), sep=",")