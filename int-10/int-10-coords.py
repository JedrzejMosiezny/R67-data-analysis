...
path_fft = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-10-post/fft'
path_rms = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-10-post/rms'
path_coords = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-10-post/coords'
print("Loaded directories...")
