...
path_data = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-05'
...
for file in filelist:
    ...
    os.chdir(path_acu)
    acoustic_data.to_csv(str('int-05_acu_' + str(timestep) + '.dat'), sep=',')
    print(str('int-05_acu_' + str(timestep) + '.dat done...'))
