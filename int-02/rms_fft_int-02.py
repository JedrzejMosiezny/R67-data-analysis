...
path_fft = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-02-post/fft'
...
#PLGRID
print("Loading directories..")
#path_data = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-02'
#path_post = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-02-post'
path_acu = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-02-post/acu'
#path_plots = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-02-post/plots'
path_rms = '/net/scratch/people/plgmosieznyj/SRS-v02/noise-data/int-02-post/rms'
print("Loaded directories...")
...
os.chdir(path_acu)
batch_pressure = dd.read_csv('int-02*', delimiter=",", decimal='.',usecols=["nodenumber", "sound-pressure"])
...
os.chdir(path_fft)
node_fft_max.to_csv(str('int-02_fft_max.dat'), sep=",")
