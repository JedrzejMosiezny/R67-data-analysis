...
#path_post = 'C:/Users/JMosiezny/Documents/01_PUT/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post'
path_acu = 'C:/Users/JMosiezny/Documents/01_PUT/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/acu'
#path_plots = 'C:/Users/JMosiezny/Documents/01_PUT/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/plots'
...
#PUT Workstation
print("Loading directories..") 
#path_data = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip'
#path_post = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post'
path_acu = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/acu'
#path_plots = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/plots'
path_signal = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/signal'
#path_rms = 'D:/01_DOKTORAT/13_PLGRID/noise-data/int-tip-post/rms'
print("Loaded directories...")

'''
print("Loading directories..")
path_data = '/net/archive/groups/plggcfdp/R67_fluent/SRS_v02/noise-data/int-tip'
...
path_signal = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-tip-post/signal'
#path_rms = '/net/scratch/people/plgmosieznyj/SRS_v02/noise-data/int-tip-post/rms'
print("Loaded directories...")
'''
...
for i in nodelist:
    ...
    node_ts.to_csv(str('int-tip_acu_node_' + str(i) +'.dat'), sep=",")